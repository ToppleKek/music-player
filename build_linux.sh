...
CXX_FILES="main.cpp vulkan.cpp linux_ichigo.cpp ./thirdparty/imgui/imgui.cpp ./thirdparty/imgui/imgui_draw.cpp ./thirdparty/imgui/imgui_tables.cpp ./thirdparty/imgui/imgui_widgets.cpp ./thirdparty/imgui/imgui_impl_sdl2.cpp ./thirdparty/imgui/imgui_impl_vulkan.cpp"
LIBS="stdc++ -lvulkan -lSDL2 -lm"
