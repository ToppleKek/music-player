...
CXX_FLAGS="-fno-exceptions -g -std=c++20 -fdeclspec"
CXX_FILES="play_queue.cpp main.cpp tags.cpp db.cpp vulkan.cpp linux_ichigo.cpp ./thirdparty/imgui/imgui.cpp ./thirdparty/imgui/imgui_draw.cpp ./thirdparty/imgui/imgui_tables.cpp ./thirdparty/imgui/imgui_widgets.cpp ./thirdparty/imgui/imgui_impl_sdl2.cpp ./thirdparty/imgui/imgui_impl_vulkan.cpp"
